...
export const CVItem = ({ titleKey, dateKey, summaryKey, children }) => {
	const { t } = useI18n();
	return (
		<div className="exp-item mb-8 p-4 border-l-4 border-blue-500 dark:border-blue-400 bg-white dark:bg-gray-800 rounded-lg shadow-md" data-aos="fade-up">
